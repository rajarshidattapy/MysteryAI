...
function Hero() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 font-mono overflow-hidden">
      {/* Video Background */}
      <video
        autoPlay
        loop
      ...
      <div className="relative z-10 flex-grow flex flex-col items-center justify-center p-6">
        <div className="max-w-2xl w-full bg-slate-800/90 backdrop-blur-sm rounded-lg shadow-xl p-8 border border-purple-900">
